...
export default function ListPage() {
  ...
  const filtered = useMemo(() => {
    ...
    switch (sort) {
      ...
      default:         return list // already newest-first from Supabase
    }
  }, [properties, maxRent, furnishing, sort])
    ...
    <div>
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-6 py-3 flex flex-wrap items-center gap-4">
        ...
        <select
          ...
          className="ml-auto text-sm border border-gray-200 rounded-lg px-3 py-1.5 text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-gray-900"
        >
      ...
      <div className="px-6 py-4">
        ...
        {!loading && !error && filtered.length === 0 && (
          <div className="text-center py-20 text-gray-400">
            ...
            <button
              onClick={() => { setMaxRent(55000); setFurnishing('all') }}
